...
export default function ResultPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-purple-900 pt-20 pb-12 px-4">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        >
          <button
            onClick={() => router.push("/")}
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-medium transition-colors transform hover:scale-105"
          >
            {t("analyzeAnother")}
          </button>
        </motion.div>
